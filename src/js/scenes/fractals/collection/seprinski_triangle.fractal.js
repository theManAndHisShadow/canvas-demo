...
export default function drawSerpinskiFractal(context, {cx, cy, h, b, borderThickness, depth, delay = 100, onRenderEnd}){
    ...
    drawSerpinskiIterative(context, {cx, cy, h, b, borderThickness, depth, delay, onRenderEnd});
}



function drawSerpinskiIterative(context, { cx, cy, h, b, borderThickness, depth, delay, onRenderEnd}) {
